...
Приложение подключается к API NSDDATA, запрашивает данные о собраниях и дивидендах за заданный период времени по бумагам, торгуемым на фондовой секции МБ и формирует Excel файл с полученными данными.
